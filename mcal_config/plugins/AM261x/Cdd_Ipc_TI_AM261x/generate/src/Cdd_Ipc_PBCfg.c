...
{
[!FOR "x" = "0" TO "1"!]
[!IF "(num:i($x) = '0' and num:i($CORE_0) = '1') or (num:i($x) = '1' and num:i($CORE_1) = '1') "!][!//
[!FOR "y" = "0" TO "1"!]
[!IF "(num:i($y) = '0' and num:i($CORE_0) = '1') or (num:i($y) = '1' and num:i($CORE_1) = '1') "!][!//
[!IF "num:i($x) != num:i($y)"!]
...
[!IF "(num:i($x) = '0' and num:i($CORE_0) = '1') or (num:i($x) = '1' and num:i($CORE_1) = '1') "!][!//
[!FOR "y" = "$x+1" TO "1"!]
[!IF "(num:i($y) = '1' and num:i($CORE_1) = '1') "!][!//
...
[!IF "(num:i($x) = '0' and num:i($SAFECORE_0) = '1') or (num:i($x) = '1' and num:i($SAFECORE_1) = '1') "!][!//
[!IF "(num:i($y) = '1' and num:i($SAFECORE_1) = '1') "!][!//
...
[!IF "((num:i($x) = '0' and num:i($SAFECORE_0) = '1') or (num:i($x) = '1' and num:i($SAFECORE_1) = '1')) and ((num:i($y) = '1' and num:i($SAFECORE_1) = '1')) "!][!//
