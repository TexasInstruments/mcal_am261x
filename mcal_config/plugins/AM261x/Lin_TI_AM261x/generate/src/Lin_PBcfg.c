...
CONST(Lin_ConfigType, LIN_CFG) LinGlobalConfig =
{
   ...
   .linChannelCfg[[!"@index"!]] =
   {
      .linControllerConfig =
      {
         .CntrAddr = [!IF "LinInstance='LIN_INSTANCE_0'"!]0x52400000U[!ELSEIF "LinInstance='LIN_INSTANCE_1'"!]0x52401000U[!ELSEIF "LinInstance='LIN_INSTANCE_2'"!]0x52402000U[!ELSE!][!ENDIF!],
