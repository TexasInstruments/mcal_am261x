...
[!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cDevErrorDetect = 'true'"!]#include "Det.h"[!ENDIF!]
...
*/
#define CDD_I2C_PRE_COMPILE_VARIANT    [!IF "(as:modconf('Cdd_I2c')[1]/IMPLEMENTATION_CONFIG_VARIANT = 'VariantPreCompile')"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/** \brief Enable/disable CDD I2c dev detect error */
#define CDD_I2C_DEV_ERROR_DETECT                                                [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cDevErrorDetect = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/** \brief Enable/disable Interrupts  */
#define CDD_I2C_POLLING_MODE                                                    [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cUseInterrupts = 'true'"!](STD_OFF)[!ELSE!](STD_ON)[!ENDIF!]

/** \brief Enable/disable version info API */
#define CDD_I2C_VERSION_INFO_API                                                [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cVersionInfoApi = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/** \brief Arbitration loss mode interrupt enabled/disabled */
#define CDD_I2C_ARBITRATION_LOSS                                                [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cArbitrationLossCheck = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]       

/** \brief CDD_I2C check to treat NACK as errors */
#define CDD_I2C_TREAT_NACK_AS_ERROR                                             [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cNackAsErrorCheck = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]    

/** \brief CDD_I2C check to enable deque API */
#define CDD_I2C_CANCEL_API                                                      [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cCancelCheck = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/** \brief CDD_I2C check to enable get driver status API */
#define CDD_I2C_GET_STATUS_API                                                  [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cStatusCheck = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]

/** \brief CDD_I2C check to process same sequence ID multiple times in queue */
#define CDD_I2C_PROCESS_SAME_SEQUENCE_MULTIPLE_TIMES_IN_QUEUE                   [!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cMultipleSequenceInQueueProcessCheck = 'true'"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
[!IF "as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cUseInterrupts = 'true' "!]
/** \brief ISR type (Only include if polling mode is off) */
#define CDD_I2C_ISR_TYPE                        ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddIrqType"!])
[!ENDIF!]
/** \brief Counter ID for counter used to count wait ticks */
#define CDD_I2C_OS_COUNTER_ID     ([!IF "not(node:empty(as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cOsCounterRef))"!][!"node:name(node:ref(as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cOsCounterRef))"!][!ELSE!][!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cDefaultOSCounterId"!]U[!ENDIF!])

/** \brief CDD_I2C arbitration loss timeout period in ticks */
#define CDD_I2C_RESET_TIMEOUT                   ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cArbitrationLossTimeout"!]U)

/** \brief CDD_I2C poll timeout period in ticks */
#define CDD_I2C_POLL_TIMEOUT                    ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cPollTimeout"!]U)

/** \brief CDD_I2C queue timeout period in ticks */
#define CDD_I2C_QUEUE_TIMEOUT                   ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cQueueTimeout"!]U)

/** \brief CDD_I2C maximum queue size to store message pointers for reception or transmission */
#define CDD_I2C_MAX_QUEUE_SIZE                  ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cQueueSize"!]U)

/** \brief CDD_I2C maximum number of Cdd_I2c_Sequence, user configurable */
#define CDD_I2C_MAXIMUM_SEQUENCE_NUMBER          ([!"num:i(count(as:modconf('Cdd_I2c')[1]/CddI2cSequenceConfig/*))"!]U)
...
#define CDD_I2C_MAXIMUM_CHANNEL_NUMBER          ([!"num:i(count(as:modconf('Cdd_I2c')[1]/CddI2cChannelConfig/*))"!]U)
...
#define CDD_I2C_TX_RX_BUFFER_MAXIMUM_SIZE       ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cMaxlengthByte"!]U)
...
#define CDD_I2C_HW_UNITS_USED                   ([!"as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cHwUnitsUsed"!]U)         
...
[!VAR "numChannelsUsed" = "num:i(as:modconf('Cdd_I2c')[1]/CddI2cGeneral/CddI2cHwUnitsUsed)"!][!//
